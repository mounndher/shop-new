...
class OrderAdmin(admin.ModelAdmin):
    ...
    list_display = ['code', 'first_name', 'last_name','house_no', 'street', 'city', 'pin', 'state', 'total', 'placed_at']

class OrderProductAdmin(admin.ModelAdmin):
    #list_display = ['order','user' , 'product', 'price', 'qty', 'amount', 'status']
    list_display = ['order' ,'product', 'price', 'qty', 'amount', 'status']
    list_editable = ('qty', 'status')
